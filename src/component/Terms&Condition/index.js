...
const Terms = () => {
  ...
  const handlesave = async () => {
    try {
      const response = await updatedoc(1, data);
      setloading(false);
    ...
    <>
      {/* <div className="languageoptions">
        <li className={lng === "english_content" ? "active_profile" : ""}>
          <Link to="/Terms&Condition?lng=english_content">English</Link>
        </li>
        <li className={lng === "francias_content" ? "active_profile" : ""}>
          <Link to="/Terms&Condition?lng=francias_content">French</Link>
        </li>
        <li className={lng === "deutsch_content" ? "active_profile" : ""}>
          <Link to="/Terms&Condition?lng=deutsch_content">Dutch</Link>
        </li>
        <li className={lng === "italiano_content" ? "active_profile" : ""}>
          <Link to="/Terms&Condition?lng=italiano_content">Italian</Link>
        </li>
      </div> */}
      ...
      <div className="container1">
        ...
        <h1 className="data_heading">Terms & Conditions</h1>
        <CKEditor
