...
const Privacy = () => {
  ...
  const handlesave = async () => {
    try {
      const response = await updatedoc("2", data);
      setloading(false);
  ...
  return (
    <>
      {/* <div className="languageoptionswithdoc"> */}
      ...
      <div className="doccontainer1">
        <div id="editor"></div>
        <h1 className="data_heading">Privacy Policy</h1>
        <CKEditor
